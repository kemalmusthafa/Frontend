      ...
      <div className="bg-white flex">
        ...
        <ul className="timeline timeline-snap-icon max-md:timeline-compact timeline-vertical">
          <li>
            ...
            <div className="timeline-start mb-10 md:text-end">
              <div className="text-lg font-black">
                Esports Indonesia Kota Bandung
              </div>
          ...
          <li>
            ...
            <div className="timeline-start mb-10 md:text-end">
              <div className="text-lg font-black">Sistem Multimedia</div>
              <div className="timeline-start mb-10 md:text-end font-bold">
                (College Project){" "}
                <time className="font-mono italic">Oct 2020 - Jan 2021</time>
              </div>
              I conducted research for developing an interactive cultural
              introduction system for children, designed the system using tools
              like Balsamiq and Figma, and implemented it using Adobe Animate.
            </div>
            <hr />
          </li>
          <li>
            ...
            <div className="timeline-end mb-10">
              <div className="text-lg font-black">Scrum Master</div>
              <div className="timeline-end mb-10 md:text-start font-bold">
                <time className="font-mono italic">Feb 2021 - Jun 2021</time>{" "}
                (College Project){" "}
              </div>
