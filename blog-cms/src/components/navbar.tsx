        ...
        <div className="bg-white h-[60px] sticky top-0 z-10 justify-between shadow-md">
            <nav>
                <Wrapper>
                    ...
                    <Link href={"/"} className="hover:text-slate-500">Beranda</Link>
                    <Link href={"/"} className="hover:text-slate-500">Berita</Link>
                    <Link href={"/"} className="hover:text-slate-500">Blog</Link>
                    </div>
                    <Link href={"/"} className="text-2xl">
